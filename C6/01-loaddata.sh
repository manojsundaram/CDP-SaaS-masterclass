...
git clone https://github.com/manojsundaram/CDP-SaaS-masterclass
 ...
 hdfs dfs -put $WKDIR/CDP-SaaS-masterclass/data/eu_countries.csv                 /hive_data/hortoniabank/eu_countries/
 hdfs dfs -put $WKDIR/CDP-SaaS-masterclass/data/us_customers_data.csv            /hive_data/hortoniabank/us_customers/
 hdfs dfs -put $WKDIR/CDP-SaaS-masterclass/data/ww_customers_data.csv            /hive_data/hortoniabank/ww_customers/
